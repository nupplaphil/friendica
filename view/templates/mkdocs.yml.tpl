  ...
  - En:
    ...
    - User:
      - First Steps:
        ...
        - Quick Start:
          - user/quick-start/quick-start-guide.md
          - user/quick-start/quick-start-network.md
          - user/quick-start/quick-start-groupsandpages.md
          - user/quick-start/quick-start-makingnewfriends.md
          - user/quick-start/quick-start-andfinally.md
        - user/text-editor.md
        - user/bbcode.md
