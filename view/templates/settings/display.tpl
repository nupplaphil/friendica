...
<form action="settings/display" id="settings-form" method="post" autocomplete="off">
	...
	<details class="settings-section">
		<summary class="settings-heading">{{$themes_title}}</summary>
	...
	{{if $theme_config}}
	<details class="settings-section">
		<summary class="settings-heading">{{$stitle}}</summary>
		{{$theme_config nofilter}}
	</details>
	{{/if}}

	<details class="settings-section">
		<summary class="settings-heading">{{$d_cset}}</summary>
	...
	<details class="settings-section">
	<summary class="settings-heading" tabindex="0">{{$timeline_title}}</summary>
	<p tabindex="0">{{$timeline_explanation}} {{$sortable}}</p>
		<details class="settings-subsection">
			<summary class="settings-subheading" tabindex="0">{{$timeline_enable}}</summary>
		...
		<details class="settings-subsection">
			<summary class="settings-subheading" tabindex="0">{{$timeline_bookmark}}</summary>
	...
	<details class="settings-section">
		<summary class="settings-heading">{{$calendar_title}}</summary>
