...
window.registerModuleLifecycle('body', function () {
	...
	$("body").off(".friendicaPhotos").on("click.friendicaPhotos", "#album-edit-link", function () {
	...
	$("body").on("click.friendicaPhotos", "#album-drop-link", function () {
		var modalUrl = $(this).attr("data-modal-url");
	...
	$("body").on("click.friendicaPhotos", "#photo-delete-link", function () {
		var modalUrl = $(this).attr("data-modal-url");
