...
class HttpClientAccept
{
	...
	public const IMAGE     = 'image/webp,image/png,image/jpeg,image/gif,image/*;q=0.9,*/*;q=0.8'; // @deprecated PHP80100 add image/avif once our minimal supported PHP version is PHP 8.1
