...
The documentation contains help on how to translate Friendica [at Transifex](./translations.md) where the UI is translated.
...
Friendica uses an implementation of [Domain-Driven-Design](./domain-driven-design.md), please make sure to check out the provided links for hints at the expected code architecture.
...
For the sake of consistency between contribution and general code readability, Friendica follows the widespread [PSR-2 coding standards](http://www.php-fig.org/psr/psr-2/) to the exception to a few rules.
...
As Friendica is using a [Twitter/GNU Social compatible API](../spec/api/index.md) any of the clients for those platforms should work with Friendica as well.
