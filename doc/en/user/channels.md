...
* from - Use "from:username" or "from:username@domain.tld" to search for posts from a specific author.
* to - Use "to:username" or "to:username@domain.tld" to search for posts with the given contact as receiver.
* group - Use "group:username" or "group:username@domain.tld" to search for posts of the given group.
* application | relay - Use "application:username" or "application:username@domain.tld" to search for posts that had been reshared by the given relay application.
